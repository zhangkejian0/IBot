...
import {
  PROFILE_ANGRY, PROFILE_CONFUSED, PROFILE_HAPPY, PROFILE_IDLE, PROFILE_LISTENING,
...
export const STATE_SPECS: Record<FaceState, StateSpec> = {
  ...
  angry:     { baseExpression: 'confused',  baseIntensity: 100, microMotionProfile: PROFILE_ANGRY },
